...
#CFtop10.style.format("{:,.0f}")

#st.dataframe(CFtop10.style.highlight_max(axis=0))
#st.table(CFtop10)
...
#Weekly_Forcast = ['WK45','WK46','WK47','WK48','WK49','WK50','WK51','WK52']
selected_Week = st.sidebar.multiselect('Select Weekly Forecast', ['WK45','WK46','WK47','WK48','WK49','WK50','WK51','WK52'],default=['WK46'],)

Show_Week=FCm[selected_Week].fillna(0)
#Show_Week=Show_Week["G-TT"] = Show_Week[selected_Week].sum(axis=1)
...
#PartNo_Forcast = ['1632','1732','2532','2633','9231','9330','1231','1530','1630','2731','2831','4333','4433','5130','5230','5330','2001','2031','2902','3102','5402',
#'6803','7702','7802','9701','0201','0231','0802','2130','2200','4600','2102','3000','3100','4900','5000','9907','9910','493C','4946','8549','8551','9112','9115','9524',
#'9115','9706','9708','0626','0628','5679','5400','5501','0702','0801','8551','0802','1771','T3100','3113','9775','9680']
...
selected_HDMC = st.sidebar.multiselect('Select HDMC',['650T','400T','350T-02','350T-01'],default=['650T'],)
...
#Show_HDMC=Show_HDMC.loc['G-Total',:]=Show_HDMC.sum(axis=0)
#'WK45','WK46','WK47','WK48','WK49','WK50','WK51','WK52'
#Show_HDMC2=FCm.loc[selected_HDMC][['WK45','WK46']]
